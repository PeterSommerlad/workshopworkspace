...
struct Width:pssst::strong<int,Width,pssst::Out>{};
struct Height:pssst::strong<int,Height,pssst::Out>{};
struct Radius:pssst::strong<int,Radius,pssst::Out>{};
...
//	out << o;
//}
void draw(char const *s,screen&os){
	os << "string:"<< s;
}
